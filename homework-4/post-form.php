...
<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        if($addRun){
            $succ_message = "Successfully saved to database with 'POST' method";
        }
        else
        {
                    ...
                    <div class="col-lg-6 text-center">
                        ...
                        <?php if (isset($succ_message)) { ?>
                            <div class="alert alert-success" role="alert">
                                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" class="mb-2" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm8.854-9.646a.5.5 0 0 0-.708-.708L7.5 7.793 6.354 6.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                                </svg>
                                <p class="text-dar"><?php echo $succ_message; ?></p>
                            </div>
                        <?php } ?>
                            ...
                            <form action="post-form.php" method="post">
                                ...
                                <div class="mb-5">
                                    <p class="d-inline-block me-2">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill="currentColor" class="bi bi-envelope-open-fill mb-2" viewBox="0 0 16 16">
